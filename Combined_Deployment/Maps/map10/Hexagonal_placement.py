...
class IncrementalDeployment:
    def __init__(self, grid_size=(90, 70), num_robots=30, sensor_range=5):
        ...
        if self.robots:
            self.robots[0].position = (self.sensor_range - 7,self.sensor_range )
...
def count_desired_area():
    ...
    # print(total_grid_without_obstacle)
...
count_desired_area()
end_time = time.time()
deployment = IncrementalDeployment(grid_size=(285, 300), num_robots=138, sensor_range=15)
