...
from grid_generator_map15 import grid
import time
...
class GreedyDeployment:
    def __init__(self, grid_size=(300, 300), num_robots=150, sensor_range=15):
        ...
        self.fig.suptitle('Greedy Robot Deployment Algorithm - Map 15')
...
deployment = GreedyDeployment(grid_size=(285, 300), num_robots=121, sensor_range=15)
...
deployment.fig.savefig('Coverage_map15.png', dpi=300, bbox_inches='tight')
deployment.save_positions('position_map15.txt')
