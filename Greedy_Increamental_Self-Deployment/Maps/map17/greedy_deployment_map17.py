...
class GreedyDeployment:
    def __init__(self, grid_size=(300, 300), num_robots=150, sensor_range=15):
        ...
        self.fig.suptitle('Greedy Robot Deployment Algorithm - Map 17')
...
deployment = GreedyDeployment(grid_size=(285, 300), num_robots=146, sensor_range=15)
...
deployment.fig.savefig('Coverage_map17.png', dpi=300, bbox_inches='tight')
deployment.save_positions('position_map17.txt')
