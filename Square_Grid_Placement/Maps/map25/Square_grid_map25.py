...
def main():
    """Main function to run square grid placement for Region 3"""
    # Create placement instance for Region 3 (index 2)
    placement = SquareGridPlacement(region_index=2, disk_radius=2)
    ...
    coverage_pct, overlap_pct = placement.generate_visualization("Coverage_map25.png")
    
    # Save summary
    with open("results_summary.txt", 'w') as f:
        f.write(f"Square Grid Placement Results - Region 3\n")
        f.write(f"=========================================\n")
