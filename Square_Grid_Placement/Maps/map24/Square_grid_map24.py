...
def main():
    ...
    # Create placement instance for Region 2 (index 1)
    placement = SquareGridPlacement(region_index=1, disk_radius=2)
    ...
    coverage_pct, overlap_pct = placement.generate_visualization("Coverage_map24.png")
    
    # Save summary
    with open("results_summary.txt", 'w') as f:
        f.write(f"Square Grid Placement Results - Region 2\n")
        f.write(f"=========================================\n")
