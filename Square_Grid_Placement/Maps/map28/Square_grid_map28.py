...
def main():
    ...
    # Create placement instance for Region 6 (index 5)
    placement = SquareGridPlacement(region_index=5, disk_radius=2)
    ...
    with open("results_summary.txt", 'w') as f:
        f.write(f"Square Grid Placement Results - Region 6\n")
        f.write(f"=========================================\n")
