...
def main():
    ...
    # Create placement instance for Region 4 (index 3)
    placement = SquareGridPlacement(region_index=3, disk_radius=2)
    ...
    with open("results_summary.txt", 'w') as f:
        f.write(f"Square Grid Placement Results - Region 4\n")
        f.write(f"=========================================\n")
