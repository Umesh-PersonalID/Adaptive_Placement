...
def main():
    """Main function to run square grid placement for Region 1 """
    # Create placement instance for Region 1 (index 0)
    placement = SquareGridPlacement(region_index=0, disk_radius=2)
    ...
    with open("results_summary.txt", 'w') as f:
        f.write(f"Square Grid Placement Results - Region 1\n")
        f.write(f"=========================================\n")
