...
def main():
    """Main function to run hexagonal grid placement for Region 1 """
    # Create placement instance for Region 1 (index 0)
    placement = HexagonalGridPlacement(region_index=0, disk_radius=2)
    ...
    coverage_pct, overlap_pct = placement.generate_visualization("Coverage_map23.png")
    
    # Save summary
    with open("results_summary.txt", 'w') as f:
        f.write(f"Hexagonal Grid Placement Results - Region 1\n")
        f.write(f"=========================================\n")
