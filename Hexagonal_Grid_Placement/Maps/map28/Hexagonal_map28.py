...
def main():
    ...
    placement = HexagonalGridPlacement(region_index=5, disk_radius=2)
    ...
    coverage_pct, overlap_pct = placement.generate_visualization("Coverage_map28.png")
    
    # Save summary
    with open("results_summary.txt", 'w') as f:
        f.write(f"Hexagonal Grid Placement Results - Region 6\n")
        f.write(f"=========================================\n")
